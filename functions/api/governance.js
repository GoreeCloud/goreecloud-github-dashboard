  ...
  try {
    ...
    return json({
      ...
      summary: {
        ...
        documentationApplicabilityModel: documentation.applicabilityModel || "unclassified",
        documentationClassifiedRepositories: documentation.classifiedRepositories || 0,
        documentationUnclassifiedRepositories: documentation.unclassifiedRepositories || 0,
        documentationApplicationRepositories: documentation.applicationRepositories || 0,
